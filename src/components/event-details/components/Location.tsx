  ...
  return (
    <div className="flex items-start gap-[1.2rem]">
      ...
      <a
        ...
        className="font-serif text-[1.6rem] text-(--color-text-inverse) underline decoration-(--color-gold) decoration-[0.5px] underline-offset-4 hover:text-(--color-gold) transition-colors duration-300 leading-[1.4] flex items-center gap-[0.6rem]"
      >
        {detail.location}
